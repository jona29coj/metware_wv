...
const UPSControl = () => {
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h1 className="text-2xl font-bold mb-6">UPS Battery Control</h1>
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        ...
                        <form>
                            ...
                            <div className="mb-4">
                                ...
                                <select id="charge-status" className="mt-1 block w-full p-2 border border-gray-300 rounded">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        ...
                        <form>
                            ...
                            <div className="mb-4">
                                ...
                                <select id="discharge-status" className="mt-1 block w-full p-2 border border-gray-300 rounded">
